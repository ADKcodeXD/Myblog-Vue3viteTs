    ...
    <div class="pic-list">
        <el-table :data="imgs" class="table" border stripe>
            ...
            <el-table-column label="原创">
                <template #header>
                    选择所有原创
                    <el-switch v-model="pageParams.isOrigin" inline-prompt active-text="是" inactive-text="否"
                        :active-value="1" :inactive-value="0" />
                </template>
                <template #default="scope">
                    <ElTag type="success" effect="dark" v-if="scope.row.origin===1">
                        原创
                    </ElTag>
                    <ElTag type="info" effect="dark" v-else>
                        非原创
                    </ElTag>
                </template>
            </el-table-column>
        ...
        <PostImg :isDialogShow="isDialogShow" 
        v-if="isDialogShow"
