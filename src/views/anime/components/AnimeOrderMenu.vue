  ...
  <div class="menu">
    <div class="menu-item">
      ...
      <p
        ...
        @click="changeType(6)"
        :class="{ active: params.type == undefined }"
      >
        全部
      </p>
      <p
        class="menu-item-type"
        @click="changeType(1)"
        :class="{ active: params.type == BroswerType.TV }"
      >
        TV
      </p>
      <p
        class="menu-item-type"
        @click="changeType(2)"
        :class="{ active: params.type == BroswerType.WEB }"
      >
        WEB
      </p>
      <p
        class="menu-item-type"
        @click="changeType(3)"
        :class="{ active: params.type == BroswerType.OVA }"
      >
        OVA
      </p>
      <p
        class="menu-item-type"
        @click="changeType(4)"
        :class="{ active: params.type == BroswerType.MOVIE }"
      >
        剧场版
      </p>
      <p
        class="menu-item-type"
        @click="changeType(5)"
        :class="{ active: params.type == BroswerType.MISC }"
      >
        其他
      </p>
    </div>
    <div class="menu-item">
      ...
      <p
        class="menu-item-type"
        @click="changeSort(1)"
        :class="{ active: params.sort === SortRole.rank }"
      >
        排名排序
      </p>
      <p
        class="menu-item-type"
        @click="changeSort(2)"
        :class="{ active: params.sort === SortRole.date }"
      >
        时间排序
      </p>
      <p
        class="menu-item-type"
        @click="changeSort(3)"
        :class="{ active: params.sort === SortRole.title }"
      >
        名称排序
      </p>
    </div>
    <div class="menu-item">
      ...
      <span class="menu-item-type" :class="{ active: yearChoice === 0 }" @click="changeYear(0)"
        >默认</span
      >
      <span
        v-for="i in 22"
        :key="i"
        class="menu-item-type"
        @click="changeYear(new Date().getFullYear() + 1 - i)"
        :class="{ active: yearChoice === new Date().getFullYear() + 1 - i }"
        >{{ new Date().getFullYear() + 1 - i }}</span
      >
    ...
    <div class="menu-item">
      ...
      <span class="menu-item-type" @click="changeMonth(0)" :class="{ active: month === 0 }"
        >默认</span
      >
      <span
        v-for="i in 12"
