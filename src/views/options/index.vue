        ...
        <div class="form">
            ...
            <div class="pannel">
                ...
                <div class="form-item">
                    ...
                    <el-select v-model="localConfig.backGroundImgRepeat" placeholder="选择重复方式" size="small">
                ...
                <div class="form-item">
                    ...
                    <el-select v-model="localConfig.backGroundImgSize" placeholder="选择重复方式" size="small">
