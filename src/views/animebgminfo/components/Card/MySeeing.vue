    ...
    <div class="tw-flex tw-flex-wrap">
      <div v-for="item in list" :key="item.name" class="box">
        ...
        >
          <div>
            <p
              class="tw-font-bold tw-text-xl tw-block tw-mb-2 text-line-show-2"
            >
              {{
            ...
            <p
              v-if="item.subject.name_cn"
              class="tw-text-slate-400 text-line-show-2"
            >
              {{ item.subject.name }}
            </p>
            <div class="tw-w-full tw-h-5 tw-bg-slate-300 tw-relative tw-my-2">
              <span
                class="
                  tw-absolute tw-left-1/2 tw-text-center
                  -tw-translate-x-1/2
                  tw-z-20 tw-font-bold
                "
              ...
              <div
                ...
                :style="
                  'width:' + (item.ep_status / item.subject.eps) * 100 + '%'
                "
              ></div>
            </div>
          </div>
