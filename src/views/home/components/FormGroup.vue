<template >
    ...
    <!-- 表单部分 -->
    <div class="form">
        <ElForm ref="formInstance" label-position="left" label-width="100px" :rules="rules" :model="formAllinfo"
            ...
            <ElFormItem label="简介" prop="introduce">
                <ElInput :disabled="!isEdit" v-model="formAllinfo.introduce" type="textarea" show-word-limit
                    maxlength="32"></ElInput>
            </ElFormItem>
        </ElForm>
    </div>
</template>
